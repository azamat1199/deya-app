  ...
  return (
    <div>
      <ScrollReveal direction="up">
        <div className="grid items-center gap-10 pt-16 lg:grid-cols-[40%_60%] lg:gap-0 lg:pt-24">
          <h2 className="max-w-[480px] text-3xl leading-tight font-light whitespace-pre-line text-ink-900 lg:text-4xl xl:text-5xl">
            {homeContent.exportMap.heading}
          </h2>

          <div className="relative mx-auto hidden aspect-[900/450] w-full max-w-[900px] md:block">
            <svg
      ...
      <ScrollReveal direction="fade">
        <div className="relative left-1/2 right-1/2 mt-12 w-screen -mx-[50vw] lg:mt-16">
          <div className="relative h-[400px] overflow-hidden md:h-[500px] lg:h-[600px] xl:h-[700px]">
            <Image
